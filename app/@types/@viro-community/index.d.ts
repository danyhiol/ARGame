declare module '@viro-community/react-viro' {
  ...
  interface ViroARSceneProps {
    ...
    postProcessEffects?: string[];
    /**
     * @deprecated DEPRECATION WARNING - this prop may be removed in future releases:  ViroARScene.onTrackingInitialized() has been DEPRECATED. Please use onTrackingUpdated() instead
     */
